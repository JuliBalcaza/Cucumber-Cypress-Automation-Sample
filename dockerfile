# This file is a Dockerfile, which contains a set of instructions for creating a custom Docker image.
# This image is specifically designed to run automated tests using
# Cypress in conjunction with Cucumber in a controlled environment.
